...
bool marvin_device_link_online(void){return mode!=20;}
...
bool marvin_update_factory_bootstrap(uint8_t *manifest){(void)manifest;return false;}
bool marvin_update_esp_bootstrap(bool healthy,const uint8_t *manifest,size_t bytes,const marvin_update_trust_t *trust){(void)healthy;(void)manifest;(void)bytes;(void)trust;return false;}
