...
import { Actions,type BatteryStatus,type DeviceCommand,type DeviceCapability,type HeadCalibration,type PetDisplaySettings,type PetEyeSettings } from '../../contracts/src/device.js';
...
export class DeviceSimulator extends EventEmitter {
 ...
 displaySettings:PetDisplaySettings={showBatteryIcon:true};
