...
export class DeviceSimulator extends EventEmitter {
 ...
 audioSettings={volume:60,muted:false};
 ...
 setAudioSettings(volume:number,muted:boolean){this.audioSettings={volume,muted};this.send({type:'audio_settings',...this.audioSettings});}
