...
export type InteractionContext = { ownerId: string; conversationId: string; interactionId: string; routeId: string; surface: Surface; repositoryId: string | null; entireState: 'disconnected' | 'fixture' | 'connected'; body: BodyState; repositoryCapabilities?:string[]; repositoryError?:string };
