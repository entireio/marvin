...
final class World {
    ...
    init() {
        ...
        for x in -5...5 { box(Double(x), 0.003, 0, 0.009, 0.005, 9.9, line).castsShadow = false }
        for z in -4...4 { box(0, 0.003, Double(z), 11.9, 0.005, 0.009, line).castsShadow = false }
        ...
        box(0, 0.007, -2.6, 1.35, 0.009, 1.25, material(0xb7cdc0), radius: 0.08).castsShadow = false
        for x in [-0.6, 0.6] { box(x, 0.015, -2.6, 0.025, 0.009, 1.1, teal).castsShadow = false }
