...
Commit `183eb17` was rebuilt cleanly and signed as `afe-v1` sequence6 after physical volume95 playback repeatedly triggered sequence5's local speech interruption. The 1,918,208-byte image has SHA256 `8a5fcb0326f29af469cea9cb05428eb0f2dfcbf1a7ac3844e38403a473cba18f`. It selected and boot-confirmed in35.223seconds with authenticated uplink, audio and advancing AFE processing; sequence5 remains the fallback. Two subsequent complete acoustic body turns produced zero self-interruptions. See the scoped M8 evidence for the deliberate half-duplex limitation.
