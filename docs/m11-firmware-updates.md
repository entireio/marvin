...
Commit `1dfa600` was later rebuilt cleanly, signed as `afe-v1` sequence5 with minimum sequence1, and offered only to the same device. The 1,918,192-byte image has SHA256 `b919a07cda4c2e272043fdbf0f09697c757da5e9e967102f07913e62eb79b4fe`. The board selected and confirmed it in32.82seconds; an independent reset check passed in16.013seconds with authenticated uplink, audio availability and AFE progress. An earlier bundle carrying the wrong `owner-v1` layout label failed before selection and left sequence4 healthy. Sequence4 remains available as the prior accepted image.

Commit `183eb17` was rebuilt cleanly and signed as `afe-v1` sequence6 after physical volume95 playback repeatedly triggered sequence5's local speech interruption. The 1,918,208-byte image has SHA256 `8a5fcb0326f29af469cea9cb05428eb0f2dfcbf1a7ac3844e38403a473cba18f`. It selected and boot-confirmed in35.223seconds; an independent reset boot check passed in13.427seconds with authenticated uplink, audio and advancing AFE processing. Sequence5 remains the fallback. Two subsequent complete acoustic body turns produced zero self-interruptions. See the scoped M8 evidence for the deliberate half-duplex limitation.
