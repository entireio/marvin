...
bool marvin_body_set_playback_mic(bool enabled);
bool marvin_body_playback_mic(void);
bool marvin_body_set_followup_seconds(unsigned seconds);
unsigned marvin_body_followup_seconds(void);
