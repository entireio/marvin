...
# silently drop the wake engine or the local track gate.
...
for option in MARVIN_LOCAL_AFE MARVIN_WAKE_AUTOSTART MARVIN_MICRO_WAKE_WORD MARVIN_HEY_MARVIN_WAKE MARVIN_TRACK_BENCH_MODE; do
