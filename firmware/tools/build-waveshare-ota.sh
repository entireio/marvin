...
idf.py -B "$project_dir/build-waveshare-ota" -D MARVIN_ENABLE_AFE=ON -D SDKCONFIG=sdkconfig.waveshare-ota.generated -D 'SDKCONFIG_DEFAULTS=sdkconfig.defaults;profiles/waveshare-provisioning.defaults;profiles/waveshare-owner.defaults;profiles/waveshare-afe.defaults;profiles/waveshare-ota.defaults' reconfigure build
